...
matplot(x=(0:K), y1, type="l", lty=1, xlab="Etapas", ylab="Probabilidad", col="black");
matlines(0:K, y2, lty=2, col="black");
matlines(0:K, y3, lty=3, col="black");
matlines(0:K, y4, lty=4, col="black");
matlines(0:K, y5, lty=5, col="black");
matlines(0:K, y6, lty=6, col="black");
matlines(0:K, y7, lty=7, col="black", pch="o");
legend(15, 1.05, legend=c("1","2","3","4","5","6","7"), col="black", lty=1:7);
